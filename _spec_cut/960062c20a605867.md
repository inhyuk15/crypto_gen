<pre>Internet Research Task Force (IRTF)                         S. Josefsson
Request for Comments: 8032                                        SJD AB
Category: Informational                                     I. Liusvaara
ISSN: 2070-1721                                              Independent
                                                            January 2017

           <span class="h1">Edwards-Curve Digital Signature Algorithm (EdDSA)</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 1]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-2" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

Table of Contents

   <a href="#section-1">1</a>.  Introduction  . . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-3">3</a>
   <a href="#section-2">2</a>.  Notation and Conventions  . . . . . . . . . . . . . . . . . .   <a href="#page-4">4</a>
   <a href="#section-3">3</a>.  EdDSA Algorithm . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-5">5</a>
     <a href="#section-3.1">3.1</a>.  Encoding  . . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-7">7</a>
     <a href="#section-3.2">3.2</a>.  Keys  . . . . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-7">7</a>
     <a href="#section-3.3">3.3</a>.  Sign  . . . . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-8">8</a>
     <a href="#section-3.4">3.4</a>.  Verify  . . . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-8">8</a>
   <a href="#section-4">4</a>.  PureEdDSA, HashEdDSA, and Naming  . . . . . . . . . . . . . .   <a href="#page-8">8</a>
   <a href="#section-5">5</a>.  EdDSA Instances . . . . . . . . . . . . . . . . . . . . . . .   <a href="#page-9">9</a>
     <a href="#section-5.1">5.1</a>.  Ed25519ph, Ed25519ctx, and Ed25519  . . . . . . . . . . .   <a href="#page-9">9</a>
       <a href="#section-5.1.1">5.1.1</a>.  Modular Arithmetic  . . . . . . . . . . . . . . . . .  <a href="#page-10">10</a>
       <a href="#section-5.1.2">5.1.2</a>.  Encoding  . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-10">10</a>
       <a href="#section-5.1.3">5.1.3</a>.  Decoding  . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-11">11</a>
       <a href="#section-5.1.4">5.1.4</a>.  Point Addition  . . . . . . . . . . . . . . . . . . .  <a href="#page-11">11</a>
       <a href="#section-5.1.5">5.1.5</a>.  Key Generation  . . . . . . . . . . . . . . . . . . .  <a href="#page-13">13</a>
       <a href="#section-5.1.6">5.1.6</a>.  Sign  . . . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-13">13</a>
       <a href="#section-5.1.7">5.1.7</a>.  Verify  . . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-14">14</a>
     <a href="#section-5.2">5.2</a>.  Ed448ph and Ed448 . . . . . . . . . . . . . . . . . . . .  <a href="#page-15">15</a>
       <a href="#section-5.2.1">5.2.1</a>.  Modular Arithmetic  . . . . . . . . . . . . . . . . .  <a href="#page-16">16</a>
       <a href="#section-5.2.2">5.2.2</a>.  Encoding  . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-16">16</a>
       <a href="#section-5.2.3">5.2.3</a>.  Decoding  . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-16">16</a>
       <a href="#section-5.2.4">5.2.4</a>.  Point Addition  . . . . . . . . . . . . . . . . . . .  <a href="#page-17">17</a>
       <a href="#section-5.2.5">5.2.5</a>.  Key Generation  . . . . . . . . . . . . . . . . . . .  <a href="#page-18">18</a>
       <a href="#section-5.2.6">5.2.6</a>.  Sign  . . . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-19">19</a>
       <a href="#section-5.2.7">5.2.7</a>.  Verify  . . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-19">19</a>
   <a href="#section-6">6</a>.  Ed25519 Python Illustration . . . . . . . . . . . . . . . . .  <a href="#page-20">20</a>
   <a href="#section-7">7</a>.  Test Vectors  . . . . . . . . . . . . . . . . . . . . . . . .  <a href="#page-23">23</a>
     <a href="#section-7.1">7.1</a>.  Test Vectors for Ed25519  . . . . . . . . . . . . . . . .  <a href="#page-24">24</a>
     <a href="#section-7.2">7.2</a>.  Test Vectors for Ed25519ctx . . . . . . . . . . . . . . .  <a href="#page-27">27</a>
     <a href="#section-7.3">7.3</a>.  Test Vectors for Ed25519ph  . . . . . . . . . . . . . . .  <a href="#page-30">30</a>
     <a href="#section-7.4">7.4</a>.  Test Vectors for Ed448  . . . . . . . . . . . . . . . . .  <a href="#page-30">30</a>
     <a href="#section-7.5">7.5</a>.  Test Vectors for Ed448ph  . . . . . . . . . . . . . . . .  <a href="#page-38">38</a>
   <a href="#section-8">8</a>.  Security Considerations . . . . . . . . . . . . . . . . . . .  <a href="#page-40">40</a>
     <a href="#section-8.1">8.1</a>.  Side-Channel Leaks  . . . . . . . . . . . . . . . . . . .  <a href="#page-40">40</a>
     <a href="#section-8.2">8.2</a>.  Randomness Considerations . . . . . . . . . . . . . . . .  <a href="#page-40">40</a>
     <a href="#section-8.3">8.3</a>.  Use of Contexts . . . . . . . . . . . . . . . . . . . . .  <a href="#page-41">41</a>
     <a href="#section-8.4">8.4</a>.  Signature Malleability  . . . . . . . . . . . . . . . . .  <a href="#page-41">41</a>
     <a href="#section-8.5">8.5</a>.  Choice of Signature Primitive . . . . . . . . . . . . . .  <a href="#page-41">41</a>
     <a href="#section-8.6">8.6</a>.  Mixing Different Prehashes  . . . . . . . . . . . . . . .  <a href="#page-42">42</a>
     <a href="#section-8.7">8.7</a>.  Signing Large Amounts of Data at Once . . . . . . . . . .  <a href="#page-42">42</a>
     <a href="#section-8.8">8.8</a>.  Multiplication by Cofactor in Verification  . . . . . . .  <a href="#page-43">43</a>
     <a href="#section-8.9">8.9</a>.  Use of SHAKE256 as a Hash Function  . . . . . . . . . . .  <a href="#page-43">43</a>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 2]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-3" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

   <a href="#appendix-A">Appendix A</a>.  Ed25519/Ed448 Python Library . . . . . . . . . . . .  <a href="#page-46">46</a>
   <a href="#appendix-B">Appendix B</a>.  Library Driver . . . . . . . . . . . . . . . . . . .  <a href="#page-58">58</a>
...
<span class="h2"><a class="selflink" id="section-1" href="#section-1">1</a>.  Introduction</span>
   ...
   The original EdDSA paper [<a href="#ref-EDDSA" title="&quot;High-speed high-security signatures&quot;">EDDSA</a>] and the generalized version
   described in "EdDSA for more curves" [<a href="#ref-EDDSA2" title="&quot;EdDSA for more curves&quot;">EDDSA2</a>] provide further
   background.  <a href="./rfc7748">RFC 7748</a> [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] discusses specific curves, including
   Curve25519 [<a href="#ref-CURVE25519">CURVE25519</a>] and Ed448-Goldilocks [<a href="#ref-ED448" title="&quot;Ed448-Goldilocks, a new elliptic curve&quot;">ED448</a>].
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 3]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-4" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h2"><a class="selflink" id="section-2" href="#section-2">2</a>.  Notation and Conventions</span>
   ...
   SHAKE256(x, y) The y first octets of SHAKE256 [<a href="#ref-FIPS202" title="&quot;SHA-3 Standard: Permutation-Based Hash and Extendable-Output Functions&quot;">FIPS202</a>] output for
                  input x
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 4]</span></pre>
...
<span class="h2"><a class="selflink" id="section-3" href="#section-3">3</a>.  EdDSA Algorithm</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 5]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   This description closely follows [<a href="#ref-EDDSA2" title="&quot;EdDSA for more curves&quot;">EDDSA2</a>].
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 6]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   See [<a href="#ref-Faster-ECC">Faster-ECC</a>] and [<a href="#ref-Edwards-revisited">Edwards-revisited</a>].
...
<span class="h3"><a class="selflink" id="section-3.2" href="#section-3.2">3.2</a>.  Keys</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 7]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-8" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h3"><a class="selflink" id="section-3.3" href="#section-3.3">3.3</a>.  Sign</span>
...
<span class="h3"><a class="selflink" id="section-3.4" href="#section-3.4">3.4</a>.  Verify</span>
...
<span class="h2"><a class="selflink" id="section-4" href="#section-4">4</a>.  PureEdDSA, HashEdDSA, and Naming</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 8]</span></pre>
...
<span class="h2"><a class="selflink" id="section-5" href="#section-5">5</a>.  EdDSA Instances</span>
...
<span class="h3"><a class="selflink" id="section-5.1" href="#section-5.1">5.1</a>.  Ed25519ph, Ed25519ctx, and Ed25519</span>
   ...
   | Parameter | Value                                                 |
   +-----------+-------------------------------------------------------+
   |     p     | p of edwards25519 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., 2^255 - 19)     |
   |     b     | 256                                                   |
   |  encoding | 255-bit little-endian encoding of {0, 1, ..., p-1}    |
   |  of GF(p) |                                                       |
   |    H(x)   | SHA-512(dom2(phflag,context)||x) [<a href="./rfc6234" title="&quot;US Secure Hash Algorithms (SHA and SHA-based HMAC and HKDF)&quot;">RFC6234</a>]            |
   |     c     | base 2 logarithm of cofactor of edwards25519 in       |
   |           | [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., 3)                                   |
   |     n     | 254                                                   |
   |     d     | d of edwards25519 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., -121665/121666  |
   |           | = 370957059346694393431380835087545651895421138798432 |
   |           | 19016388785533085940283555)                           |
   |     a     | -1                                                    |
   |     B     | (X(P),Y(P)) of edwards25519 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., (1511 |
   ...
   |     L     | order of edwards25519 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e.,             |
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                     [Page 9]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   The curve used is equivalent to Curve25519 [<a href="#ref-CURVE25519">CURVE25519</a>], under a
   change of coordinates, which means that the difficulty of the
   discrete logarithm problem is the same as for Curve25519.

<span class="h4"><a class="selflink" id="section-5.1.1" href="#section-5.1.1">5.1.1</a>.  Modular Arithmetic</span>

   For advice on how to implement arithmetic modulo p = 2^255 - 19
   efficiently and securely, see Curve25519 [<a href="#ref-CURVE25519">CURVE25519</a>].  For inversion
...
<span class="h4"><a class="selflink" id="section-5.1.2" href="#section-5.1.2">5.1.2</a>.  Encoding</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 10]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-11" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h4"><a class="selflink" id="section-5.1.3" href="#section-5.1.3">5.1.3</a>.  Decoding</span>
...
<span class="h4"><a class="selflink" id="section-5.1.4" href="#section-5.1.4">5.1.4</a>.  Point Addition</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 11]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   non-square d are described in Section 3.1 of [<a href="#ref-Edwards-revisited">Edwards-revisited</a>] and
   in [<a href="#ref-EFD-TWISTED-ADD">EFD-TWISTED-ADD</a>].  They are complete, i.e., they work for any
   ...
   of [<a href="#ref-Edwards-revisited">Edwards-revisited</a>] and in [<a href="#ref-EFD-TWISTED-DBL">EFD-TWISTED-DBL</a>] saves a few smaller
   operations.
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 12]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-13" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h4"><a class="selflink" id="section-5.1.5" href="#section-5.1.5">5.1.5</a>.  Key Generation</span>

   The private key is 32 octets (256 bits, corresponding to b) of
   cryptographically secure random data.  See [<a href="./rfc4086" title="&quot;Randomness Requirements for Security&quot;">RFC4086</a>] for a discussion
   about randomness.
...
<span class="h4"><a class="selflink" id="section-5.1.6" href="#section-5.1.6">5.1.6</a>.  Sign</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 13]</span></pre>
...
<span class="h4"><a class="selflink" id="section-5.1.7" href="#section-5.1.7">5.1.7</a>.  Verify</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 14]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-15" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h3"><a class="selflink" id="section-5.2" href="#section-5.2">5.2</a>.  Ed448ph and Ed448</span>
   ...
   | Parameter | Value                                                 |
   +-----------+-------------------------------------------------------+
   |     p     | p of edwards448 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., 2^448 - 2^224 -   |
   |           | 1)                                                    |
   |     b     | 456                                                   |
   ...
   |           | [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., 2)                                   |
   |     n     | 447                                                   |
   |     d     | d of edwards448 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., -39081)           |
   |     a     | 1                                                     |
   |     B     | (X(P),Y(P)) of edwards448 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., (224580 |
   ...
   |           | 0))                                                   |
   |     L     | order of edwards448 in [<a href="./rfc7748" title="&quot;Elliptic Curves for Security&quot;">RFC7748</a>] (i.e., 2^446 - 13818 |
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 15]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-16" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h4"><a class="selflink" id="section-5.2.1" href="#section-5.2.1">5.2.1</a>.  Modular Arithmetic</span>

   For advice on how to implement arithmetic modulo p = 2^448 - 2^224 -
   1 efficiently and securely, see [<a href="#ref-ED448" title="&quot;Ed448-Goldilocks, a new elliptic curve&quot;">ED448</a>].  For inversion modulo p, it
...
<span class="h4"><a class="selflink" id="section-5.2.2" href="#section-5.2.2">5.2.2</a>.  Encoding</span>
...
<span class="h4"><a class="selflink" id="section-5.2.3" href="#section-5.2.3">5.2.3</a>.  Decoding</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 16]</span></pre>
...
<span class="h4"><a class="selflink" id="section-5.2.4" href="#section-5.2.4">5.2.4</a>.  Point Addition</span>
   ...
   square d, are described in Section 4 of [<a href="#ref-Faster-ECC">Faster-ECC</a>] and in
   [<a href="#ref-EFD-ADD" title="&quot;Projective coordinates for Edwards curves&quot;">EFD-ADD</a>].  They are complete, i.e., they work for any pair of valid
   input points.
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 17]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   formulas described in Section 4 of [<a href="#ref-Faster-ECC">Faster-ECC</a>] and in [<a href="#ref-EFD-DBL" title="&quot;Projective coordinates for Edwards curves&quot;">EFD-DBL</a>] save
...
<span class="h4"><a class="selflink" id="section-5.2.5" href="#section-5.2.5">5.2.5</a>.  Key Generation</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 18]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-19" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h4"><a class="selflink" id="section-5.2.6" href="#section-5.2.6">5.2.6</a>.  Sign</span>
...
<span class="h4"><a class="selflink" id="section-5.2.7" href="#section-5.2.7">5.2.7</a>.  Verify</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 19]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-20" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h2"><a class="selflink" id="section-6" href="#section-6">6</a>.  Ed25519 Python Illustration</span>

   The rest of this section describes how Ed25519 can be implemented in
   Python (version 3.2 or later) for illustration.  See <a href="#appendix-A">Appendix A</a> for
   the complete implementation and <a href="#appendix-B">Appendix B</a> for a test-driver to run
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 20]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 21]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 22]</span></pre>
...
<span class="h2"><a class="selflink" id="section-7" href="#section-7">7</a>.  Test Vectors</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 23]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-24" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h3"><a class="selflink" id="section-7.1" href="#section-7.1">7.1</a>.  Test Vectors for Ed25519</span>

   These test vectors are taken from [<a href="#ref-ED25519-TEST-VECTORS">ED25519-TEST-VECTORS</a>] (but we
   removed the public key as a suffix of the private key and removed the
   message from the signature) and [<a href="#ref-ED25519-LIBGCRYPT-TEST-VECTORS">ED25519-LIBGCRYPT-TEST-VECTORS</a>].
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 24]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 25]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 26]</span></pre>
...
<span class="h3"><a class="selflink" id="section-7.2" href="#section-7.2">7.2</a>.  Test Vectors for Ed25519ctx</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 27]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 28]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 29]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-30" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h3"><a class="selflink" id="section-7.3" href="#section-7.3">7.3</a>.  Test Vectors for Ed25519ph</span>
...
<span class="h3"><a class="selflink" id="section-7.4" href="#section-7.4">7.4</a>.  Test Vectors for Ed448</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 30]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 31]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 32]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 33]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 34]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 35]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 36]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 37]</span></pre>
...
<span class="h3"><a class="selflink" id="section-7.5" href="#section-7.5">7.5</a>.  Test Vectors for Ed448ph</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 38]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 39]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-40" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h2"><a class="selflink" id="section-8" href="#section-8">8</a>.  Security Considerations</span>

<span class="h3"><a class="selflink" id="section-8.1" href="#section-8.1">8.1</a>.  Side-Channel Leaks</span>
...
<span class="h3"><a class="selflink" id="section-8.2" href="#section-8.2">8.2</a>.  Randomness Considerations</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 40]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-41" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h3"><a class="selflink" id="section-8.3" href="#section-8.3">8.3</a>.  Use of Contexts</span>
...
<span class="h3"><a class="selflink" id="section-8.4" href="#section-8.4">8.4</a>.  Signature Malleability</span>
...
<span class="h3"><a class="selflink" id="section-8.5" href="#section-8.5">8.5</a>.  Choice of Signature Primitive</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 41]</span></pre>
...
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>
   ...
   problems noted in <a href="#section-8.3">Section 8.3</a> about contexts.
...
<span class="h3"><a class="selflink" id="section-8.6" href="#section-8.6">8.6</a>.  Mixing Different Prehashes</span>
...
<span class="h3"><a class="selflink" id="section-8.7" href="#section-8.7">8.7</a>.  Signing Large Amounts of Data at Once</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 42]</span></pre>
...
<span class="h3"><a class="selflink" id="section-8.8" href="#section-8.8">8.8</a>.  Multiplication by Cofactor in Verification</span>
...
<span class="h3"><a class="selflink" id="section-8.9" href="#section-8.9">8.9</a>.  Use of SHAKE256 as a Hash Function</span>
...
<span class="h3"><a class="selflink" id="section-9.1" href="#section-9.1">9.1</a>.  Normative References</span>
   ...
   [<a id="ref-RFC2119">RFC2119</a>]  Bradner, S., "Key words for use in RFCs to Indicate
              Requirement Levels", <a href="https://www.rfc-editor.org/bcp/bcp14">BCP 14</a>, <a href="./rfc2119">RFC 2119</a>, DOI
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 43]</span></pre>
...
<span class="h3"><a class="selflink" id="section-9.2" href="#section-9.2">9.2</a>.  Informative References</span>
   ...
   [<a id="ref-ED25519-LIBGCRYPT-TEST-VECTORS">ED25519-LIBGCRYPT-TEST-VECTORS</a>]
              Koch, W., "Ed25519 Libgcrypt test vectors", July 2014,
              &lt;<a href="http://git.gnupg.org/cgi-bin/">http://git.gnupg.org/cgi-bin/</a>
              gitweb.cgi?p=libgcrypt.git;a=blob;f=tests/t-ed25519.inp;
              h=e13566f826321eece65e02c593bc7d885b3dbe23;hb=refs/
              heads/master&gt;.

   [<a id="ref-ED25519-TEST-VECTORS">ED25519-TEST-VECTORS</a>]
              Bernstein, D., Duif, N., Lange, T., Schwabe, P., and B.
              Yang, "Ed25519 test vectors", July 2011,
              &lt;<a href="http://ed25519.cr.yp.to/python/sign.input">http://ed25519.cr.yp.to/python/sign.input</a>&gt;.

   [<a id="ref-ED448">ED448</a>]    Hamburg, M., "Ed448-Goldilocks, a new elliptic curve",
              June 2015, &lt;<a href="http://eprint.iacr.org/2015/625">http://eprint.iacr.org/2015/625</a>&gt;.

   [<a id="ref-EDDSA">EDDSA</a>]    Bernstein, D., Duif, N., Lange, T., Schwabe, P., and B.
              Yang, "High-speed high-security signatures",
              DOI 10.1007/978-3-642-23951-9_9, September 2011,
              &lt;<a href="http://ed25519.cr.yp.to/ed25519-20110926.pdf">http://ed25519.cr.yp.to/ed25519-20110926.pdf</a>&gt;.

   [<a id="ref-EDDSA2">EDDSA2</a>]   Bernstein, D., Josefsson, S., Lange, T., Schwabe, P., and
              B. Yang, "EdDSA for more curves", July 2015,
              &lt;<a href="http://ed25519.cr.yp.to/eddsa-20150704.pdf">http://ed25519.cr.yp.to/eddsa-20150704.pdf</a>&gt;.

   [<a id="ref-Edwards-revisited">Edwards-revisited</a>]
              Hisil, H., Wong, K., Carter, G., and E. Dawson, "Twisted
              Edwards Curves Revisited",
              DOI 10.1007/978-3-540-89255-7_20, December 2008,
              &lt;<a href="http://eprint.iacr.org/2008/522">http://eprint.iacr.org/2008/522</a>&gt;.

   [<a id="ref-EFD-ADD">EFD-ADD</a>]  Bernstein, D. and T. Lange, "Projective coordinates for
              Edwards curves", The 'add-2007-bl' addition formulas,
              2007, &lt;<a href="http://www.hyperelliptic.org/EFD/g1p/auto-edwards-projective.html#addition-add-2007-bl">http://www.hyperelliptic.org/EFD/g1p/</a>
              <a href="http://www.hyperelliptic.org/EFD/g1p/auto-edwards-projective.html#addition-add-2007-bl">auto-edwards-projective.html#addition-add-2007-bl</a>&gt;.

<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 44]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-45" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

   [<a id="ref-EFD-DBL">EFD-DBL</a>]  Bernstein, D. and T. Lange, "Projective coordinates for
              Edwards curves", The 'dbl-2007-bl' doubling formulas,
              2007, &lt;<a href="http://www.hyperelliptic.org/EFD/g1p/auto-edwards-projective.html#doubling-dbl-2007-bl">http://www.hyperelliptic.org/EFD/g1p/</a>
              <a href="http://www.hyperelliptic.org/EFD/g1p/auto-edwards-projective.html#doubling-dbl-2007-bl">auto-edwards-projective.html#doubling-dbl-2007-bl</a>&gt;.

   [<a id="ref-EFD-TWISTED-ADD">EFD-TWISTED-ADD</a>]
              ...
              &lt;<a href="http://www.hyperelliptic.org/EFD/g1p/auto-twisted-extended-1.html#addition-add-2008-hwcd-3">http://www.hyperelliptic.org/EFD/g1p/</a>
              <a href="http://www.hyperelliptic.org/EFD/g1p/auto-twisted-extended-1.html#addition-add-2008-hwcd-3">auto-twisted-extended-1.html#addition-add-2008-hwcd-3</a>&gt;.

   [<a id="ref-EFD-TWISTED-DBL">EFD-TWISTED-DBL</a>]
              Hisil, H., Wong, K., Carter, G., and E. Dawson, "Extended
              coordinates with a=-1 for twisted Edwards curves", The
              'dbl-2008-hwcd' doubling formulas, December 2008,
              &lt;<a href="http://www.hyperelliptic.org/EFD/g1p/auto-twisted-extended-1.html#doubling-dbl-2008-hwcd">http://www.hyperelliptic.org/EFD/g1p/</a>
              <a href="http://www.hyperelliptic.org/EFD/g1p/auto-twisted-extended-1.html#doubling-dbl-2008-hwcd">auto-twisted-extended-1.html#doubling-dbl-2008-hwcd</a>&gt;.

   [<a id="ref-Faster-ECC">Faster-ECC</a>]
              Bernstein, D. and T. Lange, "Faster addition and doubling
              on elliptic curves", DOI 10.1007/978-3-540-76900-2_3,
              July 2007, &lt;<a href="http://eprint.iacr.org/2007/286">http://eprint.iacr.org/2007/286</a>&gt;.
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 45]</span></pre>
<hr class='noprint'/><!--NewPage--><pre class='newpage'><span id="page-46" ></span>
<span class="grey"><a href="./rfc8032">RFC 8032</a>                EdDSA: Ed25519 and Ed448            January 2017</span>

<span class="h2"><a class="selflink" id="appendix-A" href="#appendix-A">Appendix A</a>.  Ed25519/Ed448 Python Library</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 46]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 47]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 48]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 49]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 50]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 51]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 52]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 53]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 54]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 55]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 56]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 57]</span></pre>
...
<span class="h2"><a class="selflink" id="appendix-B" href="#appendix-B">Appendix B</a>.  Library Driver</span>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 58]</span></pre>
...
<span class="grey">Josefsson &amp; Liusvaara         Informational                    [Page 59]</span></pre>
